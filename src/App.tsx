...
// 공단 주요 행정 용어 사전 데이터 (정확하고 간결한 괄호 설명 제공)
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1100 620" width="1100" height="620">
  <defs>
    <style>
      .bg { fill: #F8FAFC; }
      .title { font-family: 'Inter', 'Noto Sans KR', 'Malgun Gothic', sans-serif; font-size: 24px; font-weight: 800; fill: #0B2540; }
      .subtitle { font-family: 'Inter', 'Noto Sans KR', 'Malgun Gothic', sans-serif; font-size: 13px; font-weight: 500; fill: #4B5563; }
      .card-bg { fill: #FFFFFF; stroke: #E2E8F0; stroke-width: 1.5; filter: drop-shadow(0 2px 4px rgba(0,0,0,0.03)); }
      .card-header-1 { fill: #005BAC; }
      .card-header-2 { fill: #0D9488; }
      .card-header-3 { fill: #D97706; }
      .card-header-4 { fill: #1E3A8A; }
      .card-title { font-family: 'Inter', 'Noto Sans KR', 'Malgun Gothic', sans-serif; font-size: 13.5px; font-weight: 700; fill: #FFFFFF; }
      .text-title { font-family: 'Inter', 'Noto Sans KR', 'Malgun Gothic', sans-serif; font-size: 13px; font-weight: 700; fill: #1E293B; }
      .text-desc { font-family: 'Inter', 'Noto Sans KR', 'Malgun Gothic', sans-serif; font-size: 11.5px; fill: #475569; font-weight: 500; }
      .arrow { fill: none; stroke: #4B5563; stroke-width: 3; stroke-linecap: round; stroke-linejoin: round; }
    </style>
  </defs>
  
  <!-- 16:9 비율의 깨끗하고 차분한 연회색 배경 -->
  <rect width="1100" height="620" rx="16" class="bg" stroke="#E2E8F0" stroke-width="1.5" />
  
  <!-- 타이틀 영역 (보고자료에 완벽히 부합하는 톤앤매너) -->
  <g transform="translate(41, 55)">
    <text x="0" y="0" class="title">근로복지공단 방문 전 QR 길잡이 서비스 흐름도</text>
    <text x="0" y="24" class="subtitle">QR 한 번으로 민원유형 확인, 준비서류 점검, 공식 신청 경로 연결까지 지원하는 방문 전 민원 안내 모델</text>
  </g>
  
  <!-- ①번 카드: QR 접속 및 방문 전 안내 -->
  <g transform="translate(41, 125)">
    <rect width="235" height="340" rx="16" class="card-bg" />
    <rect width="235" height="48" rx="16" class="card-header-1" />
    <rect y="32" width="235" height="16" class="card-header-1" />
    <text x="117.5" y="28" text-anchor="middle" class="card-title">① QR 접속 및 방문 전 안내</text>
    
    <!-- 스마트폰 QR 스캔 비주얼 벡터 그래픽 -->
    <circle cx="117.5" cy="110" r="32" fill="#EFF6FF" />
    <rect x="105" y="90" width="25" height="40" rx="4" fill="none" stroke="#005BAC" stroke-width="2.5" />
    <line x1="109" y1="94" x2="126" y2="94" stroke="#005BAC" stroke-width="2.5" stroke-linecap="round" />
    <circle cx="117.5" cy="123" r="2.5" fill="#005BAC" />
    <path d="M 88 100 L 96 100 M 88 100 L 88 108" fill="none" stroke="#D1D5DB" stroke-width="2" />
    <path d="M 147 100 L 139 100 M 147 100 L 147 108" fill="none" stroke="#D1D5DB" stroke-width="2" />
    <path d="M 88 120 L 88 112 M 147 120 L 147 112" fill="none" stroke="#D1D5DB" stroke-width="2" />
    
    <!-- 핵심 내용 Bullet Points -->
    <text x="22" y="185" class="text-desc">- 포스터 · 안내문 QR 스캔</text>
    <text x="22" y="215" class="text-desc">- 모바일 웹 즉시 접속</text>
    <text x="22" y="245" class="text-desc">- 별도 앱 설치 없이 이용</text>
    <text x="22" y="275" class="text-desc">- 지사 방문 전 준비사항 확인</text>
  </g>
  
  <!-- ① ➜ ② 자연스럽고 명확한 고체 화살표 연결 -->
  <path d="M 283 295 L 295 295 M 290 290 L 295 295 L 290 300" class="arrow" />
  
  <!-- ②번 카드: 민원유형 선택 · 준비서류 확인 -->
  <g transform="translate(302, 125)">
    <rect width="235" height="340" rx="16" class="card-bg" />
    <rect width="235" height="48" rx="16" class="card-header-2" />
    <rect y="32" width="235" height="16" class="card-header-2" />
    <text x="117.5" y="28" text-anchor="middle" class="card-title">② 민원유형 선택 · 준비서류 확인</text>
    
    <!-- 체크리스트 비주얼 벡터 그래픽 -->
    <circle cx="117.5" cy="110" r="32" fill="#F0FDFA" />
    <rect x="102" y="92" width="31" height="36" rx="3" fill="none" stroke="#0D9488" stroke-width="2.5" />
    <path d="M 97 105 L 107 105" stroke="#0D9488" stroke-width="3" stroke-linecap="round" />
    <path d="M 120 100 L 124 104 L 132 94" fill="none" stroke="#14B8A6" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
    <line x1="108" y1="112" x2="124" y2="112" stroke="#0D9488" stroke-width="2" />
    <line x1="108" y1="120" x2="120" y2="120" stroke="#0D9488" stroke-width="2" />
    
    <text x="22" y="185" class="text-desc">- 산재 · 가입 · 복지 등 유형 선택</text>
    <text x="22" y="215" class="text-desc">- 민원별 필수 준비서류 체크</text>
    <text x="22" y="245" class="text-desc">- 방문 전 자진 보완사항 안내</text>
    <text x="22" y="275" class="text-desc">- 온라인 신청 기능 여부 표시</text>
  </g>
  
  <!-- ② ➜ ③ 자연스럽고 명확한 고체 화살표 연결 -->
  <path d="M 544 295 L 556 295 M 551 290 L 556 295 L 551 300" class="arrow" />
  
  <!-- ③번 카드: 공식 신청 · 서식 경로 연결 -->
  <g transform="translate(563, 125)">
    <rect width="235" height="340" rx="16" class="card-bg" />
    <rect width="235" height="48" rx="16" class="card-header-3" />
    <rect y="32" width="235" height="16" class="card-header-3" />
    <text x="117.5" y="28" text-anchor="middle" class="card-title">③ 공식 신청 · 서식 경로 연결</text>
    
    <!-- 공공포털 공식 연결 문서와 링크 아이콘 -->
    <circle cx="117.5" cy="110" r="32" fill="#FFFBEB" />
    <rect x="100" y="93" width="26" height="34" rx="3" fill="none" stroke="#D97706" stroke-width="2.5" />
    <circle cx="126" cy="118" r="8" fill="#FFFBEB" stroke="#D97706" stroke-width="2" />
    <path d="M 123 118 L 129 118 M 126 115 L 126 121" stroke="#D97706" stroke-width="2" stroke-linecap="round" />
    <line x1="106" y1="101" x2="116" y2="101" stroke="#D97706" stroke-width="2" />
    <line x1="106" y1="108" x2="120" y2="108" stroke="#D97706" stroke-width="2" />
    
    <text x="22" y="185" class="text-desc">- 공단 · 정부24 주요 포털 연동</text>
    <text x="22" y="215" class="text-desc">- 부처별 공통서류 다운로드 제공</text>
    <text x="22" y="245" class="text-desc">- 유관 스마트 웹 바로가기 제공</text>
    <text x="22" y="275" class="text-desc">- 인근 지사 위치 및 전화망 연결</text>
  </g>
  
  <!-- ③ ➜ ④ 자연스럽고 명확한 고체 화살표 연결 -->
  <path d="M 805 295 L 817 295 M 812 290 L 817 295 L 812 300" class="arrow" />
  
  <!-- ④번 카드: 방문 접수 효율화 · 재방문 감소 -->
  <g transform="translate(824, 125)">
    <rect width="235" height="340" rx="16" class="card-bg" />
    <rect width="235" height="48" rx="16" class="card-header-4" />
    <rect y="32" width="235" height="16" class="card-header-4" />
    <text x="117.5" y="28" text-anchor="middle" class="card-title">④ 방문 접수 효율화 · 재방문 감소</text>
    
    <!-- 창구 안내 및 완료 성공 아이콘 -->
    <circle cx="117.5" cy="110" r="32" fill="#EEF2F6" />
    <rect x="99" y="94" width="37" height="30" rx="3" fill="none" stroke="#1E3A8A" stroke-width="2.5" />
    <path d="M 94 124 L 141 124" stroke="#1E3A8A" stroke-width="2.5" stroke-linecap="round" />
    <circle cx="117.5" cy="106" r="12" fill="#10B981" />
    <path d="M 113 106 L 116 109 L 122 102" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    
    <text x="22" y="185" class="text-desc">- 준비서류 누락 없는 즉각 통과</text>
    <text x="22" y="215" class="text-desc">- 대기 피로 해소 및 신속 접수</text>
    <text x="22" y="245" class="text-desc">- 내방 수검 및 보완 차단</text>
    <text x="22" y="275" class="text-desc">- 직원의 부가적인 행정 소모 경감</text>
  </g>
  
  <!-- 하단 중요 성과 리포트 배너 -->
  <g transform="translate(41, 495)">
    <rect width="1018" height="90" rx="12" fill="#F1F5F9" stroke="#CBD5E1" stroke-width="1.5" />
    <text x="25" y="32" font-family="'Inter', 'Noto Sans KR', 'Malgun Gothic', sans-serif" font-size="14" font-weight="800" fill="#0F294A">🎯 핵심 실행 가치 및 지사 업무 개선 효과</text>
    <text x="25" y="58" font-family="'Inter', 'Noto Sans KR', 'Malgun Gothic', sans-serif" font-size="11.5" font-weight="500" fill="#334155">
      방문 전 준비서류 확인으로 불필요한 재방문을 획기적으로 줄이고, 온라인 신청 가능한 민원은 최적의 공식 경로로 연결함으로써
    </text>
    <text x="25" y="75" font-family="'Inter', 'Noto Sans KR', 'Malgun Gothic', sans-serif" font-size="11.5" font-weight="500" fill="#334155">
      현장 창구의 대기시간 완화 효과와 더불어 지사 행정 직원의 동일한 구두 설명 피로도를 원천 차단하는 실행 가치를 보장합니다.
    </text>
  </g>
</svg>`;
    ...
    link.href = url;
    link.download = 'comwel_visit_qr_guide_architecture.svg';
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
    URL.revokeObjectURL(url);
    triggerToast('방문 전 QR 길잡이 아키텍처 SVG 파일 다운로드가 시작되었습니다!');
  };
            ...
            <main className="mx-auto w-full max-w-4xl px-4 pb-14 flex-1">
                              ...
                              {[0, 1, 2, 3].map((index) => {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    {/* 자가 검인 진척률 축약 배지 */}
                                    {prep.checkedCount > 0 && (
                                      <span className="bg-[#FAF2EA] text-[#A66E38] text-[9px] font-black px-1.5 py-0.5 rounded border border-[#F2DECE] shrink-0 self-center">
              ...
              <section className="bg-white border-2 border-[#EBE3D3] rounded-[24px] p-5.5 sm:p-7 shadow-md text-left mt-6 relative overflow-hidden">
                ...
                <div className="flex items-center gap-2 border-b border-[#E3DAC8] pb-3 mb-4.5">
                  ...
                  <div>
                    <h3 className="text-base font-black text-brand-brown font-serif flex items-center gap-1.5">
                      공단 핵심 행정 용어 정리
                    </h3>
                    ...
                    return (
                      <div
                        ...
                        className={`rounded-xl border transition-all overflow-hidden ${
                          isOpen 
                            ? 'bg-[#FAF8F5] border-[#D9CEB5] shadow-3xs' 
                            : 'bg-[#FCFAF7]/60 border-[#EDE9DF] hover:bg-[#FAF6EE] hover:border-[#DDF0E5]/10'
                        }`}
                      >
                        <button
                        ...
                        >
                          <div className="min-w-0 pr-1">
                            <span className="text-xs font-black text-[#33251E] hover:text-brand-accent transition-colors block sm:inline mr-1.5">
                              {item.term}
                            </span>
                            <span className="text-[10.5px] font-bold text-brand-accent italic leading-none inline-block">
                              {item.spec}
                            </span>
                          </div>
                          <span className="text-[10px] font-bold text-[#8C7667] shrink-0 bg-white border border-[#EDE9DF] px-1.5 py-0.5 rounded-md shadow-3xs select-none">
                            {isOpen ? '닫기 ▲' : '열기 ▼'}
                          </span>
                        </button>
                        ...
                        <AnimatePresence initial={false}>
                          {isOpen && (
                            ...
                            >
                              <div className="px-4 pb-4 pt-1 border-t border-dashed border-[#EDE9DF] text-[11px] font-semibold text-[#514339] leading-relaxed">
                                {item.definition}
                              </div>
                            </motion.div>
                          )}
              ...
              {/* 아키텍처 다운로드 섹션 */}
              <section className="rounded-2xl border border-sky-200 bg-[#E8F2FC]/45 p-5 text-left mt-6 shadow-3xs flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="space-y-1">
                  <div className="inline-flex items-center gap-1.5 rounded-full bg-sky-50 px-2.5 py-0.5 text-[9px] font-black text-[#005BAC] border border-sky-100 uppercase tracking-widest">
                    SYSTEM ARCHITECTURE
                  </div>
                  <h4 className="text-sm sm:text-base font-black text-[#0B2540] tracking-tight">
                    방문 전 QR 길잡이 아키텍처 원본 설계 다운로드
                  </h4>
                  <p className="text-slate-600 leading-relaxed text-[11px] sm:text-xs">
                    민원인의 구비 지참 자진확인 및 무대기 공단 업무 협동 프로세스를 도식화한 고해상도 아키텍처(.svg) 백터 파일을 원클릭으로 간편하게 전송 및 소장할 수 있습니다.
                  </p>
                </div>
                <button
                  type="button"
                  onClick={downloadArchitectureSVG}
                  className="w-full md:w-auto shrink-0 inline-flex items-center justify-center gap-2 rounded-xl bg-[#005BAC] text-white hover:bg-[#004B8D] active:scale-97 transition-all px-5 py-3 font-bold text-xs sm:text-sm cursor-pointer shadow-sm shadow-sky-900/15"
                >
                  <FileDown className="h-4.5 w-4.5" />
                  <span>아키텍처 SVG 다운로드</span>
                </button>
              </section>
            ...
            <main className="mx-auto w-full max-w-2xl px-4 py-6 flex-1 space-y-6">
              ...
              <section className="space-y-1.5 text-left">
                ...
                <div className="bg-white border border-[#EDE9DF] rounded-2xl p-4.5 shadow-2xs">
                  <p className="text-xs sm:text-sm font-semibold text-[#514339] leading-relaxed">
              ...
              <section className="space-y-1.5 text-left">
                ...
                <div className="bg-white border border-[#EDE9DF] rounded-2xl p-4.5 shadow-2xs colwel-gradient">
                  <ul className="space-y-4">
                    {activeCard.cases.map((cs, idx) => (
                      <li key={idx} className="flex gap-2.5 items-start text-xs sm:text-sm text-[#514339] font-semibold leading-normal">
                        <span className="h-5 px-1.5 rounded-md bg-[#FAF2EA] text-[9px] font-black text-[#A66E38] flex items-center justify-center shrink-0 mt-0.5 select-none font-serif border border-[#F2DECE]">
                          사례 {idx + 1}
                        </span>
                        <span>{cs}</span>
                      </li>
                    ...
                    {activeCard.requiredDocs.map((doc, idx) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full flex items-center justify-between p-3.5 text-left rounded-xl border text-xs sm:text-sm font-semibold transition-all cursor-pointer ${
                            isChecked
                              ? 'bg-emerald-50/40 border-emerald-200/50 text-[#4F7B5A] shadow-2xs'
                              : 'bg-[#FAF8F5] border-[#EDE9DF] text-[#514339] hover:bg-[#F5ECE1]'
                          }`}
                        >
                          <span className={isChecked ? 'line-through text-slate-400 font-medium' : 'text-[#33251E] font-extrabold'}>
                            <span className="text-[#C45E5E] font-black mr-1 text-xs">★</span>
                            {doc}
                          </span>

                          <div className={`h-[22px] w-[22px] rounded-full border flex items-center justify-center shrink-0 transition-colors ${
                            isChecked ? 'bg-[#4F7B5A] border-[#4F7B5A] text-white' : 'border-[#D9CEB5] bg-white hover:border-brand-brown-light'
                          }`}>
                    ...
                    return (
                      <div className="pt-2 flex flex-col gap-1.5 text-[10px] border-t border-[#EDE9DF]/50 mt-1">
                        <div className="flex-1 bg-[#EBF3ED] h-[5px] rounded-full overflow-hidden">
                          <div 
                            className="bg-[#4F7B5A] h-full transition-all duration-300"
                            style={{ width: `${percentage}%` }}
                          />
                        </div>
                        <div className="flex justify-between items-center text-brand-brown-light font-bold">
                          <span>지참 서류 완성도</span>
                          <span className="text-[#4F7B5A] font-serif">
                            {percentage}% ({checkedCount}/{total})
                          </span>
                        </div>
                      </div>
              ...
              <section className="space-y-2 text-left">
                <div className="flex items-center justify-between border-b border-[#EDE9DF] pb-1.5">
                  <h4 className="text-xs font-bold text-[#514339] tracking-wide uppercase flex items-center gap-1.5 font-serif">
                    <span className="h-1.5 w-1.5 rounded-full bg-[#514339]" />
                    민원 심사 및 처리절차
                  </h4>
                  <span className="text-xs font-serif italic text-brand-brown-light font-medium">
                    ...
                    return (
                      <div key={idx} className="flex gap-4 items-start text-xs sm:text-sm leading-relaxed relative z-10 font-bold">
                        ...
                        <div className={`h-[24px] w-[24px] rounded-full text-[9px] font-black flex items-center justify-center shrink-0 mt-0.5 select-none border transition-all ${
                          isDone 
                            ? 'bg-brand-brown border-brand-brown text-white shadow-3xs'
                            : isCurrent
                              ? 'bg-[#FAF2EA] border-[#A66E38] text-[#A66E38]'
                              : 'bg-white border-[#EDE9DF] text-slate-400'
                        }`}>
                          {isDone ? (
                        ...
                        <div className="flex-1 space-y-0.5">
                          <div className="flex items-center gap-2">
                            <span className={`text-[11px] font-black ${isDone ? 'text-[#8C7667]' : 'text-[#33251E]'}`}>
                              {idx + 1}단계
                            </span>
                            <span className={`inline-block text-[8px] sm:text-[9px] font-black px-1.5 py-0.5 rounded ${
                              isDone 
                                ? 'bg-[#F4F7F4] text-[#4F7B5A] border border-[#E2EBE5]' 
                                : isCurrent
                                  ? 'bg-[#FDF2EA] text-[#A66E38] border border-[#F3E0CD]' 
                                  : 'bg-[#FAF8F5] text-slate-450 border border-[#EDE9DF]'
                            }`}>
              ...
              <section className="space-y-1.5 text-left">
                ...
                <div className="bg-[#FAF8F5] border border-[#EDE9DF] rounded-2xl p-4.5 shadow-2xs space-y-2 text-xs sm:text-sm font-extrabold text-[#33251E] leading-relaxed">
                  ...
                  <p className="text-[10px] sm:text-xs text-[#8C7667] font-semibold leading-normal">
                    💡 굳이 지사에 직접 방문하셔서 오랜 시간 번호표를 뽑고 기다리지 마시고, 컴퓨터나 모바일을 이용하시면 팩스/대기 비용 0원으로 즉시 안전하게 서류가 통보 수립됩니다. 비대면 방식을 권장해 드립니다.
                  </p>
                </div>
              </section>
              ...
              <section className="space-y-3.5 pt-4">
                ...
                <div className="flex flex-col gap-2.5">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    onClick={() => triggerToast(`[안내] "${activeCard.onlineUrlLabel}" 토탈서비스 연동 페이지로 이동합니다.`)}
                  ...
                  <div className="grid grid-cols-3 gap-2.5 font-bold">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      onClick={() => triggerToast('[대화] 온라인 민원 및 서식 다운로드가 가능한 고용산재토탈 서비스로 연결됩니다.')}
                      className="inline-flex flex-col items-center justify-center gap-1.5 rounded-2xl bg-white border border-[#EDE9DF] px-3 py-3.5 text-xs text-brand-brown hover:bg-[#FAF8F5] active:scale-97 transition-all shadow-3xs cursor-pointer no-underline text-center"
                    >
                    ...
                    {/* 지사 찾기 및 지사 청구 안내 - 근로복지공단 공식 연결 */}
                    <a
                      href="https://www.comwel.or.kr/comwel/intr/orgn/find.jsp"
                      target="_blank"
                      rel="noopener noreferrer"
                      onClick={() => triggerToast('[안내] 근로복지공단 공식 지사 찾기 맵 페이지로 이동합니다.')}
                      className="inline-flex flex-col items-center justify-center gap-1.5 rounded-2xl bg-white border border-[#EDE9DF] px-3 py-3.5 text-xs text-brand-brown hover:bg-[#FAF8F5] active:scale-97 transition-all shadow-3xs cursor-pointer no-underline text-center"
                    >
